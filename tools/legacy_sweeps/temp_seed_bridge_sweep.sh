...
run focused_contact_seed_baseline
run focused_contact_seed_bridge1 \
  --rear-swing-bridge-hold-s 0.12 \
  --rear-swing-bridge-forward-scale 0.20 \
  --rear-swing-bridge-roll-threshold 0.42 \
  --rear-swing-bridge-pitch-threshold 0.28 \
  --rear-swing-bridge-height-ratio 0.60 \
  --rear-swing-bridge-recent-front-window-s 0.24 \
  --rear-swing-bridge-lookahead-steps 3
run focused_contact_seed_bridge2 \
  --rear-swing-bridge-hold-s 0.16 \
  --rear-swing-bridge-forward-scale 0.15 \
  --rear-swing-bridge-roll-threshold 0.38 \
  --rear-swing-bridge-pitch-threshold 0.26 \
  ...
  --touchdown-support-side-rebalance-delta 0.06
