...
from experiments.quasistatic_confirmed_helper_fixed import QuasiStaticParams, ConfirmedQuasiStaticCrawl
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--desired-speed-cap", type=float, default=0.06)
    ...
    p.add_argument("--target-height-frac", type=float, default=0.82)
    ...
    p.add_argument("--step-len-front", type=float, default=0.040)
