...
from experiments.quasistatic_confirmed_helper_heightfix import QuasiStaticParams, ConfirmedQuasiStaticCrawl
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--output-dir", type=str, default="local_outputs/outputs_mujoco_quasistatic_fixed")
