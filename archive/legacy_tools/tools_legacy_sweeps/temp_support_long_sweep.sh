...
run focused_contact_seed_support_long1 \
  --front-touchdown-confirm-hold-s 0.10 \
  --touchdown-confirm-forward-scale 0.20 \
  --front-touchdown-settle-hold-s 0.16 \
  --touchdown-settle-forward-scale 0.30
run focused_contact_seed_support_long2 \
  --front-touchdown-confirm-hold-s 0.12 \
  --touchdown-confirm-forward-scale 0.18 \
  --front-touchdown-settle-hold-s 0.18 \
  --touchdown-settle-forward-scale 0.28 \
  --touchdown-support-rear-floor-delta 0.12 \
  --touchdown-support-roll-angle-gain-delta 5.0 \
  --touchdown-support-roll-rate-gain-delta 1.5 \
  --touchdown-support-pitch-angle-gain-delta 9.0 \
  --touchdown-support-pitch-rate-gain-delta 2.5
