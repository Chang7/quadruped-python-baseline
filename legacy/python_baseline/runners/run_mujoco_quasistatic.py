...
from low_level_realizer import (
...
from quasistatic_confirmed_helper_heightfix import QuasiStaticParams, ConfirmedQuasiStaticCrawl
from quasistatic_visual_helpers import (
    make_free_camera,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--output-dir", type=str, default=str(ROOT / 'outputs' / 'mujoco'))
    p.add_argument("--headless", action="store_true")
    p.add_argument("--disable-nonfoot-collision", action="store_true")

    # timing / gait
    p.add_argument("--startup-time", type=float, default=0.70)
    p.add_argument("--shift-time", type=float, default=0.18)
    p.add_argument("--swing-time", type=float, default=0.20)
    p.add_argument("--touchdown-wait", type=float, default=0.22)
    p.add_argument("--hold-time", type=float, default=0.12)
    p.add_argument("--desired-speed-cap", type=float, default=0.04)

    # support
    p.add_argument("--support-enabled", action="store_true")
    p.add_argument("--support-weight-start", type=float, default=0.95)
    p.add_argument("--support-weight-end", type=float, default=0.70)
    p.add_argument("--support-fade-start", type=float, default=0.4)
    p.add_argument("--support-fade-end", type=float, default=3.0)
    p.add_argument("--target-height-frac", type=float, default=1.02)
    p.add_argument("--support-xy-k", type=float, default=120.0)
    p.add_argument("--support-xy-d", type=float, default=20.0)
    p.add_argument("--support-z-k", type=float, default=340.0)
    p.add_argument("--support-z-d", type=float, default=40.0)
    p.add_argument("--support-roll-k", type=float, default=18.0)
    p.add_argument("--support-roll-d", type=float, default=2.2)
    p.add_argument("--support-pitch-k", type=float, default=16.0)
    p.add_argument("--support-pitch-d", type=float, default=2.0)
    p.add_argument("--support-yaw-k", type=float, default=5.0)
    p.add_argument("--support-yaw-d", type=float, default=1.0)
    p.add_argument("--support-max-force-xy", type=float, default=55.0)
    p.add_argument("--support-max-force-z", type=float, default=260.0)
    ...
    p.add_argument("--mpc-force-gain-end", type=float, default=0.18)
    p.add_argument("--mpc-force-ramp-start", type=float, default=0.8)
    p.add_argument("--mpc-force-ramp-end", type=float, default=2.4)
    p.add_argument("--max-xy-over-fz", type=float, default=0.25)

    # foot motion
    p.add_argument("--clearance", type=float, default=0.060)
    p.add_argument("--step-len-front", type=float, default=0.032)
    p.add_argument("--rear-step-scale", type=float, default=0.85)
    p.add_argument("--touchdown-depth-front", type=float, default=0.012)
    p.add_argument("--touchdown-depth-rear", type=float, default=0.015)
    p.add_argument("--touchdown-extra", type=float, default=0.006)
    p.add_argument("--dq-limit", type=float, default=0.12)
    p.add_argument("--visual-step-boost", type=float, default=1.0)

    # stance shaping
    p.add_argument("--stance-press-front", type=float, default=0.006)
    p.add_argument("--stance-press-rear", type=float, default=0.007)
    p.add_argument("--stance-press-gain", type=float, default=0.00025)
    p.add_argument("--stance-fx-bias-gain", type=float, default=0.00035)
    p.add_argument("--stance-fy-bias-gain", type=float, default=0.00030)
    p.add_argument("--shift-x-mag", type=float, default=0.010)
    p.add_argument("--shift-y-mag", type=float, default=0.012)
    p.add_argument("--touchdown-confirm-hold", type=float, default=0.06)

    # recovery
    p.add_argument("--recovery-height-enter-frac", type=float, default=0.60)
    p.add_argument("--recovery-height-exit-frac", type=float, default=0.72)
    p.add_argument("--recovery-pitch-enter", type=float, default=0.45)
    p.add_argument("--recovery-roll-enter", type=float, default=0.35)
    p.add_argument("--recovery-pitch-exit", type=float, default=0.22)
    p.add_argument("--recovery-roll-exit", type=float, default=0.18)
    p.add_argument("--recovery-min-time", type=float, default=0.12)

    p.add_argument("--recovery-enable-after", type=float, default=1.20)
    p.add_argument("--recovery-force-exit-after", type=float, default=0.55)
    p.add_argument("--recovery-required-contacts", type=int, default=3)
...
def run_quasistatic(args):
    ...
    params = QuasiStaticParams(
        ...
        recovery_enable_after=args.recovery_enable_after,
        recovery_force_exit_after=args.recovery_force_exit_after,
        recovery_required_contacts=args.recovery_required_contacts,
