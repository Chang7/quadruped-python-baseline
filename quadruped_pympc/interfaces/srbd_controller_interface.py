...
class SRBDControllerInterface:
    ...
    def __init__(self):
        ...
        # 'linear_osqp' plugs an external linear force MPC into the same PyMPC realization stack
        ...
        elif self.type == "linear_osqp":
            from quadruped_pympc.controllers.linear_osqp import LinearSRBDController

            self.controller = LinearSRBDController()
